...
const Planet = ({ planetRef, setLinks, showBox }) => {
  ...
  const content = {
    ...
    tech: 'The tech stack used here is based around React Three Fiber which is an abstraction of three.js which is, itself, an abstraction of WebGL. Blender was used to create the models shown here. Special thanks to the Poimandres team and their many helpful components that make creating these projects even more enjoyable!',
