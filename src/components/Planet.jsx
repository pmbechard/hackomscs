...
const Planet = ({ planetRef, setLinks, showBox }) => {
  ...
  const content = {
    ...
    guy: "My name is Peyton Bechard. I am starting OMSCS in Fall 2024 doing either CS or HCI… haven't quite decided. I am a self-taught programmer, high school math and CS teacher, have an MA Humanities, former North Korean tour guide and project manager, licensed Canadian Risk Manager, and I am a month or two away from being a father.",
    contact:
